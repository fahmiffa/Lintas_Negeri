                ...
                @endif                    
                    ...
                    <div class="px-5">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="name" value="{{isset($job) ? $job->name : old('name')}}"   class="form-control">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="number"  id="kouta" name="kouta" value="{{isset($job) ? number_format($job->kouta, 0, ",", ".") : old('kouta')}}"   class="form-control">
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-md-3">Interview Location</label>
                            <div class="col-md-6">                                
