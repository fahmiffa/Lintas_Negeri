    ...
    <section class="section">
        <div class="card">       
            <div class="card-body">
                ...
                @isset($third)
                <form action="{{route('third.update',['third'=>$third])}}" method="post" enctype="multipart/form-data">                            
                @method('PATCH')   
                @else                                      
                ...
                @endif                    
                    ...
                    <div class="px-5">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="name" value="{{isset($third) ? $third->name : old('name')}}"   class="form-control">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="choices form-select" name="account">
                                    ...
                                    <option value="{{$item->id}}"  @selected(isset($third) && $third->users_id == $item->id)>{{ucfirst($item->name)}}</option>
                                    @endforeach                       
                                </select>
