...
<head>
    ...
    <style>
        #auth {
            background: url(https://zuramai.github.io/mazer/assets/images/bg.svg), white no-repeat center bottom;
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-12">
                <div class="mt-5 mx-5 card card-body shadow-sm">
                    <h1 class="text-center" style="font-size: 5rem"><i class="bi bi-flower1"></i></h1><br>
