...
<table style="width: 100%; border-collapse:collapse; border: 1px solid black; text-align:center">
  <tr>
    <td style="background-color: rgb(244, 175, 132); border: 1px solid black;  border-collapse:collapse; border: 1px solid black;">
      氏名<br>
      Name</td>
    <td colspan="4" style="border: 1px solid black;">{{$data->user->name}}</td>    
  ...
  <tr>
    ...
    <td colspan="2" style="border: 1px solid black;">{{auth()->user()->hp}}</td>
  ...
  <tr>
    ...
    <td style="border: 1px solid black;">{{($data->smoker == 1) ? 'Ya' : 'Tidak'}}</td>    
  </tr>
  ...
  <tr>
    <td style="border: 1px solid black;">{{($data->look == 0) ? 'Kanan' : 'Kiri'}}</td>
    <td style="border: 1px solid black;">{{$data->blood}}</td> 
    <td style="border: 1px solid black;">{{($data->hand == 1) ? 'Kanan' : 'Kiri'}}</td>
    <td style="border: 1px solid black;">{{$data->learning}} Bulan</td>   
    <td style="border: 1px solid black;">{{($data->alkohol == 1) ? 'Ya' : 'Tidak'}}</td>
  </tr>
  <tr>    
    <td style="background-color: rgb(244, 175, 132); border: 1px solid black; ">視力 Daya penglihatan</td>
  ...
  <tr>
    ...
    <td style="border: 1px solid black;">{{($data->japan == 1) ? 'Ya' : 'Tidak'}}</td>
    <td style="border: 1px solid black;">{{($data->accident == 1) ? 'Ya' : 'Tidak'}}</td>
    <td style="border: 1px solid black;">{{($data->sick == 1) ? 'Ya' : 'Tidak'}}</td>
  ...
  <tr>
    ...
    <td colspan="2" style="border: 1px solid black;">{{$job[$i][1]}}</td>
  ...
  <tr>
    ...
    <td colspan="2" style="border: 1px solid black;">{{$magang[$i][1]}}</td>
    <td colspan="2" style="border: 1px solid black;">{{$magang[$i][2]}}</td>
  </tr>
  @endfor
...
<table style="width: 100%; border-collapse:collapse; border: 1px solid black; text-align:center">
  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">仕事内容</td>  
  </tr>  
  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">Deskripsi Pekerjaan
    </td>  
  </tr>
  <tr>
    <td colspan="6" style="border: 1px solid black; ">{{$data->job_des}}</td>  
  </tr>  

  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">実習で学んだ事</td>  
  </tr>  
  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">Hal yang Dipelajari saat magang
    </td>  
  </tr>
  <tr>
    <td colspan="6" style="border: 1px solid black; ">{{$data->magang_des}}</td>  
  </tr>  


  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">自己P㻾、希望、質問等
    </td>  
  </tr>  
  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">Promosi diri, harapan, pertanyaan, dll.</td>  
  </tr>
  <tr>
    <td colspan="6" style="border: 1px solid black; ">{{$data->me}}</td>  
  </tr>  


  {{-- family --}}
  <tr>
    <td colspan="6" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">家族構成 Keluarga</td>  
  </tr>
  <tr>    
    <td colspan="2" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">続柄 Hubungan</td>
    <td colspan="2" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">家族氏名 Nama</td>  
    <td colspan="2" style="background-color: rgb(244, 175, 132); border: 1px solid black; ">年齢 Usia</td>  
  </tr>
  @php
  ...
  @if(count($dad) > 0)
  <tr>
    <td colspan="2" style="border: 1px solid black;">Ayah</td>
  ...
  @endphp
  <tr>
    <td colspan="2" style="border: 1px solid black;">Ibu</td>
  ...
  @if(count($bro) > 0)
  <tr>
    <td colspan="2" style="border: 1px solid black;">Kakak</td>
  ...
  @if(count($sis) > 0)
  <tr>
    <td colspan="2" style="border: 1px solid black;">Adik</td>
